...
public class find_second_smallest_and_second_largest_element_in_an_array {
    ...
    public static void main(String[] args) {
        ...
        int sS = find_second_smallest_and_second_largest_element_in_an_array.secondSmallest(arr, n);
        int sL = find_second_smallest_and_second_largest_element_in_an_array.secondLargest(arr, n);
